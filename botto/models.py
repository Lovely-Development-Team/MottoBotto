...
class AirTableError(Exception):
    def __init__(self, response_dict: dict, *args: object) -> None:
    ...
    def __repr__(self) -> str:
        return "{class_name}(type:{error_type}, message:{error_message})".format(
    ...
    def __str__(self) -> str:
        return "Error from AirTable operation of type '{error_type}', with message:{error_message}".format(
            error_type=self.error_type,
            error_message=self.error_message
        )
